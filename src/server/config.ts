...
export interface Config {
  ...
  oneTimeCode: string;
  oneTimeCodeAutoGenerated: boolean;
  cookieSecret: string;
...
export function loadConfig(): Config {
  ...
  if (!env("UPI_ID")) {
    process.stderr.write("WARN: UPI_ID is not set. QR codes will not render in the admin panel.\n");
  }
  ...
  return {
    ...
    oneTimeCodeAutoGenerated: !env("ONE_TIME_CODE"),
