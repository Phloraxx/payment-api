...
export function Login({ onSuccess }: { onSuccess: () => void }) {
  ...
  return <main className="login-page">
    <section className="login-card">
      <Brand subtitle="Payment infrastructure" />
      <div className="login-copy"><p className="eyebrow">Operator access</p><h1>Payments, without the noise.</h1><p>Sign in with the PayGate admin password. The phone relay runs independently of this dashboard session.</p></div>
      ...
      <footer>Private runtime · signed relay · durable webhooks</footer>
    </section>
  </main>;
}
